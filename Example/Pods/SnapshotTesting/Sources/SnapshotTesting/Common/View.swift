    ...
    import SpriteKit
        ...
        public struct ViewImageConfig {
            ...
            public init(safeArea: UIEdgeInsets = .zero,
                        size: CGSize? = nil,
            ...
            #elseif os(tvOS)
                public static let tv = ViewImageConfig(safeArea: .init(top: 60, left: 90, bottom: 60, right: 90),
                                                       size: .init(width: 1920, height: 1080),
                                                       traits: .init())
                public static let tv4K = ViewImageConfig(safeArea: .init(top: 120, left: 180, bottom: 120, right: 180),
...
//        .init(displayScale: 3),
    ...
    extension View {
        ...
        func prepareView(config: ViewImageConfig,
                         ...
                         viewController: UIViewController) -> () -> Void
        {
            ...
            if drawHierarchyInKeyWindow {
                ...
                window = Window(config: .init(safeArea: config.safeArea, size: config.size ?? size, traits: traits),
        ...
        func snapshotView(config: ViewImageConfig,
                          drawHierarchyInKeyWindow: Bool,
                          traits: UITraitCollection,
                          view: UIView,
            ...
            -> Async<UIImage>
        {
            ...
            let dispose = prepareView(config: config,
