    ...
    public extension Snapshotting where Value == CGPath, Format == NSImage {
        ...
        static func image(precision: Float = 1, drawingMode: CGPathDrawingMode = .eoFill) -> Snapshotting {
    ...
    public extension Snapshotting where Value == CGPath, Format == UIImage {
        ...
        ///
        /// - Parameter precision: The percentage of pixels that must match.
        static func image(precision: Float = 1, scale: CGFloat = 1, drawingMode: CGPathDrawingMode = .eoFill) -> Snapshotting {
            SimplySnapshotting.image(precision: precision).pullback { path in
                let bounds = path.boundingBoxOfPath
